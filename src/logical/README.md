...
# Logical decoding surface

Append-only CDC from PostgreSQL heap tables into Iceberg
(`pgiceberg.create_logical_mirror` and the background worker).

Mirror configuration and progress live in `pgiceberg.logical_mirrors`. The
